...
<?php
    ...
    $resultfecha = mysqli_query($conexion, "SELECT id, reportero, subtitulo, correo, titulo, categoria, fecha, imagen, noticia FROM noticias WHERE id = '1'");
...
<article id ="post" class ="container">
    ...
    <div class="author">
    <img src="<?=base_url();?>assets/imagenes/avatar.png" alt="Author image" />
    <div class="info">
